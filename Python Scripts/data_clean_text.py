...
df['Description']=df['Description'].apply(lambda x: remove_punc(x.lower()))
...
def remove_stopwords(text):
  words=[c for c in text if c not in stopwords.words('english') and c not in custom_stop_words]
