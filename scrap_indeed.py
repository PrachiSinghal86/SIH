...
for i in range(0, 1300,10):
    driver.get('https://www.indeed.co.in/jobs?q=data%20scientist&l=India&advn=66394628884245&vjk=e9751f653e50dc82&start=' + str(i))
...
df.to_csv("Data_scientist_latest.csv", index=False)